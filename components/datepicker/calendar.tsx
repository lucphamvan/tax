...
const Calendar: React.FC<CalendarProps> = (props) => {
  ...
  return (
    <div
      {...calendarProps}
      className="calendar flex flex-col gap-3 text-[#8b6441] font-semibold text-sm"
    >
  ...
  return (
    <td {...cellProps} className="text-center align-middle">
      <div
        ...
        className={`${style.cell} ${isSelected ? style.selected : ""} ${
          isDisabled ? "disabled" : ""
        } ${
          isUnavailable ? "unavailable" : ""
        } px-[10px] py-[8px] focus:outline-none`}
      >
        {formattedDate}
      </div>
    </td>
